...
public class DBUtil {
    ...
    public Map<String, String> getTableCommentMap(String tname) throws Exception {
        Connection conn = null;
        Statement statement = null;
        Map<String, String> map = new TreeMap<String, String>();
        try {
            ...
            ResultSet colRet = dbMetData.getColumns(null, "%", tname, "%");
            while (colRet.next()) {
                map.put(colRet.getString("REMARKS").trim(), colRet.getString("COLUMN_NAME").toUpperCase());
            }
        } catch (Exception e) {
            throw new Exception(e);
        } finally {
    ...
    public boolean checkTableExist(String tname) {
        ...
        try {
            ...
            statement = conn.createStatement();
            DatabaseMetaData dbMetData = conn.getMetaData();
            rs = dbMetData.getTables(null, convertDatabaseCharsetType("root", "mysql"), null,
    ...
    public static void main(String[] args) throws Exception {
        Object o = new DBUtil("com.mysql.jdbc.Driver",
                "jdbc:mysql://172.119.119.100:3306/report?useUnicode=true&characterEncoding=UTF-8", "zhoufei",
                "zhoufei").getTableColumnMap("report_data_source");
