$(function() {
   ...
   $(document).delegate('.edit','click',function(){
	   ...
	   location.href = contextPath + "/dataSource/add?id=" + id;
   })
   $(document).delegate('.stop','click',function(){
	   var id = $(this).attr("data-id");
	   $.confirm("确定要停用记录吗？",function(ok){
  		   if(ok){
  			   location.href = contextPath + "/dataSource/setStatus?id=" + id;
  		   }
	   });
   })
   ...
   $(document).delegate('#fn-btn-add','click',function() {
	   location.href = contextPath + "/view/datasource/add.jsp";
   });
